...
- [x] Remove the root copy of ./skills-encrypted, It is no longer used. Additionally; remove any references to the root copy. Be aware another folder with this name IS used, in ./shared. (done 2026-08-19: also removed the empty root ./memory and the dangling root ./pre-commit symlink that pointed at a long-gone ./00-tools)
